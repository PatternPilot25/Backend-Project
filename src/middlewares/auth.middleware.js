...
export const verifyJwt = asyncHandler(async(req,_,next)=>{
  console.log("cookies in auth middleware:",req.cookies)
   try {   // here cookies are parsed by cookie-parser middleware & available in req.cookies
     ...
     const decodedToken = jwt.verify(token,process.env.ACCESS_TOKEN_SECRET) // if token is invalid or expired it throws an error which is caught in catch block
